<div class="col-side-bar-menu">
    ...
    <ul class="menu">
        <li><a href="{{route('user.panel')}}" @if(str_contains($view_name,"-user-panel"))class="active"@endif><i class="fi fi-rr-apps icon"></i> داشبورد</a></li>
        <li><a href="#"><i class="fi fi-rr-heart icon"></i> لیست علاقمندی</a></li>
        <li><a href="{{route('user.comment')}}" @if(str_contains($view_name,"-user-comment"))class="active"@endif><i class="fi fi-rr-comment icon"></i> نظرات</a></li>
